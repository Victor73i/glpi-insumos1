                        ...
                        <div class="row g-3">
                            <div class="col-xxl-5 col-sm-12">
                                <div class="search-box">
                                    <input type="text" class="form-control search bg-light border-light" name="search" placeholder="Buscar por Tareas o Otra Cosa..." value="{{ request('search') }}">
                        ...
                        <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                            ...
                            @foreach($tareas as $tarea)
                                ...
                                <tr>
                                    ...
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">{{ $tarea->glpi_users->name ?? 'Sin Usuario' }}</a></td>
                                    ...
                                    <td class="">{{ $tarea->glpi_tickets->name ?? 'Sin Tickets' }}</td>
    ...
    <div class="modal fade zoomIn" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form method="POST" class="tablelist-form" action="{{route('tareas.update' , ['tarea'=>$tarea])}}" autocomplete="off">
                    @csrf
                    @method('PUT')
