            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="hstack gap-2 justify-content-center">
                        ...
                        <a class="btn btn-success btn-sm" href="{{route('tareas.edit', [$tareas->id])}}"><i class="ri-play-circle-line align-bottom me-1"></i> Editar</a>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card mb-3">
                    ...
                    <div class="table-card">
                        <table class="table mb-0">
                            ...
                            <tr>
                                ...
                                <td>{{$tareas->fecha_asignacion}}</td>
                            </tr><tr>
                                <td class="fw-medium">Fecha Aproximada</td>
                                <td>{{$tareas->fecha_aproximada}}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="text-muted">
                        ...
                        <div class="pt-3 border-top border-top-dashed mt-4">
                            ...
                            <div class="hstack flex-wrap gap-2 fs-15">
                                <div class="badge fw-medium badge-soft-info">Creado {{$tareas->created_at->diffForHumans()}}</div>
                                <div class="badge fw-medium badge-soft-info">Actualizado {{$tareas->updated_at->diffForHumans()}}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form action="{{route('tareas.destroy',['tarea' =>$tareas->id])}}" method="POST">
                            @csrf
                            @method('DELETE')
