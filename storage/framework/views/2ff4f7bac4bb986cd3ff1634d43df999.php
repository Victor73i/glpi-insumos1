<?php $__env->startSection('title','Agregar Reporte Insumo Fungible'); ?>

<?php $__env->startSection('content'); ?>

    <form method="POST" action="<?php echo e(route('reporte_insumo_fungibles.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
            <label for="nota">
                Nota
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <select style="background-color: #e3f2fd;" class="form-control" required name="id_equipo_it" id="id_equipo_it"
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses(['border-red-500' => $errors->has('id_equipo_it')]); ?>" value="<?php echo e(old('id_equipo_it')); ?>">
                <option value="">Seleccione un Equipo It</option>
                <?php $__currentLoopData = $equipo_its; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipo_it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="<?php echo e(route('reporte_insumo_fungibles.index')); ?>" class="link">Cancel</a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\glpi-insumos\resources\views/reporte_insumo_fungible/create.blade.php ENDPATH**/ ?>