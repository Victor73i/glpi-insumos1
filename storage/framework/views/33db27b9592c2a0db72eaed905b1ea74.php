                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img class="rounded" alt="200x200" width="200" src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row g-3 mt-5">
                                    ...
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" alt="" class="rounded-circle avatar-xl">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xl</code></p>
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\glpi-insumos\resources\views/ui-images.blade.php ENDPATH**/ ?>