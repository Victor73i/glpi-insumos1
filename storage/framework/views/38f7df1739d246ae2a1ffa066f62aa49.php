                        ...
                        <div class="mx-n3">
                            <div data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="primary" style="max-height: 275px;">
                                ...
                                <a href="#!" class="text-reset notification-item d-block dropdown-item active">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-xs me-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="rounded-circle img-fluid" alt="user-pic">
                                        </div>
                                        <div class="flex-grow-1 text-muted">
                                ...
                                <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-xs me-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" class="rounded-circle img-fluid" alt="user-pic">
                                        </div>
                                        <div class="flex-grow-1 text-muted">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\glpi-insumos\resources\views/advance-ui-scrollbar.blade.php ENDPATH**/ ?>