<?php $__env->startSection('title','Edit LOG'); ?>

<?php $__env->startSection('content'); ?>

    <form method="POST" action="<?php echo e(route('logs.update', [$log->id])); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
            ...
            <input text="text" name="observaciones" id="observaciones"
                   ...
                   value="<?php echo e($log->observaciones); ?>"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <select name="id_equipo_computo[]" id="id_equipo_computo"
                    ...
                    value="<?php echo e($log->id_equipo_computo); ?>" multiple="multiple">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\glpi-insumos\resources\views/log/edit.blade.php ENDPATH**/ ?>