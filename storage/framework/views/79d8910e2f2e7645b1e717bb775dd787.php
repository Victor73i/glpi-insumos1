                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/eth.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xmr.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/dash.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/mkr.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/neo.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <tbody class="list form-check-all">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/mkr.svg')); ?>" alt="" class="avatar-xxs me-2" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/yfi.svg')); ?>" alt="" class="avatar-xxs me-2" />
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\glpi-insumos\resources\views/apps-crypto-wallet.blade.php ENDPATH**/ ?>