            ...
            <div class="row">
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\glpi-insumos\resources\views/ui-cards.blade.php ENDPATH**/ ?>