                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="subscribe-modals-cover h-100">
                                            <img src="<?php echo e(URL::asset('assets/images/modals/imagen-fondo.jpg')); ?>" alt="" class="h-100 w-100 object-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.modal-content -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\default\resources\views/ui-modals.blade.php ENDPATH**/ ?>
